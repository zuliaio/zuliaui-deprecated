package io.zulia.ui.client.charting;

import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.user.client.ui.FlowPanel;
import io.zulia.ui.client.charting.options.ChartOptions;
import io.zulia.ui.client.charting.options.CreditOptions;
...
public class Highcharts extends FlowPanel {
	...
	protected final native void draw(HighchartsOptions highchartsOptions) /*-{
        this.@io.zulia.ui.client.charting.Highcharts::chart = new $wnd.Highcharts.Chart(highchartsOptions);

    }-*/;

	public final native void reflow()/*-{
        this.@io.zulia.ui.client.charting.Highcharts::chart.reflow();
    }-*/;
