...
import io.zulia.ui.client.charting.handlers.TooltipFormatter;
...
public class TooltipOptions extends JavaScriptObject {
	...
	public final native TooltipOptions setFormatter(TooltipFormatter formatter) /*-{
        this.formatter = function () {
            return formatter.@io.zulia.ui.client.charting.handlers.TooltipFormatter::format(Ljava/lang/String;Ljava/lang/String;Lio/zulia/ui/client/charting/options/Series;)(this.x.toString(), this.y.toString(), this.series);
        };
        return this;
    }-*/;
