...
public class Footer extends MaterialFooter {
	...
	public Footer() {
		...
		MaterialLabel label = new MaterialLabel("Zulia is distributed under a commercially friendly Apache Software license");
		...
		sourceButton.addClickHandler(
				clickEvent -> Window.open("https://github.com/zuliaio/zuliasearch", "_blank", "menubar=1,status=1,toolbar=1,scrollbars=1,resizable=1"));
